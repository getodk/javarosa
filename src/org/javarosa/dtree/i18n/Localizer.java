...
public class Localizer {
	...
	/**
	 * Register an ILocalizable to receive updates with the locale is changed. If the ILocalizable is already
	 * registered, nothing happens.
	 * 
	 * @param l ILocalizable to register.
	 */
	public void registerLocalizable (ILocalizable l) {
		if (!observers.contains(l))
			observers.addElement(l);
	}
	
	/**
	 * Unregister an ILocalizable from receiving locale change updates. No effect if the ILocalizable was never
	 * registered in the first place.
	 * 
	 * @param l ILocalizable to unregister.
	 */
	public void unregisterLocalizable (ILocalizable l) {
	...
	private void alertLocalizables () {
		for (Enumeration e = observers.elements(); e.hasMoreElements(); )
			((ILocalizable)e.nextElement()).localeChanged(currentLocale, this);
	}
}
