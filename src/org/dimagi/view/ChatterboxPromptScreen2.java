...
public class ChatterboxPromptScreen2 extends MVCComponent implements IPrompter {
	 ...
	 * Creates a new DForm.
	 */
	public ChatterboxPromptScreen2() {
		System.out.println("ChatterboxPromptScreen2()");
		screen = new ChatScreenForm();
	}
...
//		System.out.println("ChatterboxPromptScreen2.paint()");
...
//	}
	...
	public void showPrompt(Prompt prompt, int screenIndex, int totalScreens) {
		System.out.println("ChatterboxPromptScreen2.showPrompt(prompt, screenIndex, totalScreens)");
		this.p = prompt;
