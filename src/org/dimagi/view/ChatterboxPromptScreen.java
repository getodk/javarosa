...
public class ChatterboxPromptScreen extends MVCComponent implements IPrompter, ItemCommandListener {
	...
	public ChatterboxPromptScreen() {
		System.out.println("prompt screen init");
	}

	public ChatterboxPromptScreen(Prompt p) {
		this.p = p;
	}

	public ChatterboxPromptScreen(Prompt p, int screenIndex, int totalScreens) {
		this.p = p;
