...
public class TreeReferenceContextualizeTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
            ...
            {"Contextualizing a ref with itself and multiplicity #2", buildRef("/foo[-1]"), buildRef("/foo[2]"), buildRef("/foo[2]")},
            {"Contextualizing a ref with itself and multiplicity #3", buildRef("/foo[0]"), buildRef("/foo[2]"), buildRef("/foo[2]")},
            {"Contextualizing a ref with itself and multiplicity #4", buildRef("/foo[3]"), buildRef("/foo[2]"), buildRef("/foo[2]")},
