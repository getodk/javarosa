...
public class BindAttributeProcessorTest {
    ...
    @Test
    public void doesNotProcessAttributeWithIncorrectNamespace() throws IOException {
    ...
    @Test
    public void doesNotRemovettributeWithIncorrectNamespace() throws IOException {
        XFormsElement form = XFormsElement.html(
            asList(
                new Pair<>("blah", "blah"),
                new Pair<>("notBlah", "notBlah")
