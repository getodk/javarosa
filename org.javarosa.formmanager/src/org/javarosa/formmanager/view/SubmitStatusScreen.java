...
public class SubmitStatusScreen extends Form  {
	...
	public void updateStatus (int status) {
		...
		case TransportMessage.STATUS_DELIVERED: message = ("Form has been submitted successfully! Your reference is: "+s);
		break;
		case TransportMessage.STATUS_FAILED:    message = "Submission failed! Please try to submit the form again later in 'View Saved'.";
		break;
		default:                                message = "Unknown sending error; form not sent!";
		break;
		}
