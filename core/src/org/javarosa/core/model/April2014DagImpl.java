...
/**
 * The April 2014 eval logic as of javarosa-2014-04-29.jar
 * (also applies to javarosa-2014-03-07.jar and later).
 *
...
public class April2014DagImpl extends IDag {
	 ...
	 * @param t
	 */
	private void fillTriggeredElements(EvaluationContext evalContext,
			QuickTriggerable qt, ArrayList<QuickTriggerable> destination) {
		if (qt.t.canCascade()) {
	 ...
	 */
	private void addChildrenOfReference(EvaluationContext evalContext,
			TreeReference original, ArrayList<TreeReference> toAdd) {
	...
	private void addChildrenOfElement(TreeElement el,
