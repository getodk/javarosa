...
public abstract class GetFormHttpStateGet implements State,TrivialTransitions,HandledCommandListener,TransportListener {
	...
	public GetFormHttpStateGet() {
	}
	
	public abstract String getURL();

	public void fetchForm(){
		SimpleHttpTransportMessageGet message = new SimpleHttpTransportMessageGet("",getURL());
	...
	public void onStatusChange(TransportMessage message) {
		SimpleHttpTransportMessageGet httpMessage = (SimpleHttpTransportMessageGet)message;
