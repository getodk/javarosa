 ...
 * 
 */
public class SimpleHttpTransporterGet implements Transporter {

	/**
	 * The message to be sent by this Transporter
	 */
	private SimpleHttpTransportMessageGet message;

	/**
	 * @param message
	 *            The message to be sent
	 */
	public SimpleHttpTransporterGet(SimpleHttpTransportMessageGet message) {
	...
	public void setMessage(TransportMessage m) {
		...
		this.message = (SimpleHttpTransportMessageGet) m;
	...
	public TransportMessage send() {
		...
		try {
			...
			String response = new String(this.message.getResponseBody());
