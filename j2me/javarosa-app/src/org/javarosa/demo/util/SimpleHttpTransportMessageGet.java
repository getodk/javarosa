 ...
 * 
 */
public class SimpleHttpTransportMessageGet extends BasicTransportMessage {
	...
	public SimpleHttpTransportMessageGet() {
	 ...
	 */
	public SimpleHttpTransportMessageGet(String str, String url) {
	 ...
	 * @param destinationURL
	 */
	public SimpleHttpTransportMessageGet(byte[] str, String url) {
		content = str;
		this.url = url;
	}
	 ...
	 * @throws IOException
	 */
	public SimpleHttpTransportMessageGet(InputStream is, String url)
			throws IOException {
	...
	public Transporter createTransporter() {
		return new SimpleHttpTransporterGet(this);
	}
