...
public abstract class HttpDestinationRetrievalState implements GetDestinationTransitions, State, CommandListener {
	
	GetURLForm form;

	public void start () {
		form = new GetURLForm(((HttpTransportMethod) TransportManager._().getTransportMethod(
