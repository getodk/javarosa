...
1. If there is an [issue](https://github.com/opendatakit/javarosa/issues) corresponding to what you will work on, **comment on it** to say you are addressing it. If there is no issue yet, create one to provide background on the problem you are solving.
