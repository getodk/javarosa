# Contributing code to ODK JavaRosa
...
1. If there is an [issue](https://github.com/opendatakit/javarosa/issues) corresponding to what you will work on, put `@opendatakit-bot claim` as a comment on issue to say you are claiming it. If there is no issue yet, create one to provide background on the problem you are solving.
