...
public class DataModelTreeMetaDataTests extends TestCase{
	...
	public void testConstructors(){
		...
		//assertEquals("Default constructor for DataModelTreeMetaData not properly initialized",d.toString(),null);
