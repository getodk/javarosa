...
public class FormOverview {
	...
	public static String overview (FormDef f, String locale) {
		...
		//StringBuilder outputBuffer = dumpTranslations(f,0,sb);
...
//		for (int i = 0; i < q.getNumChoices(); i++) {
	...
	private static void printProperty (String property, FormDef f, TreeElement instanceNode, int indent, StringBuilder sb) {
	...
	private static void println (StringBuilder sb, int indent, String line) {
